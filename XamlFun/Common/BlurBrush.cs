...
{
    /// <summary>
    /// The <see cref="BlurBrush"/> is a <see cref="Brush"/> that blurs whatever is behind it in the application.
    /// </summary>
    public class BlurBrush : XamlCompositionBrushBase
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="BlurBrush"/> class.
        /// </summary>
        public BlurBrush()
        {
        }
